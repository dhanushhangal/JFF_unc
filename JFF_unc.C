...
void JFF_unc(){
    ...
    for(int ibin=0;ibin<4;ibin++){
      ...
      for(int ibin3=0;ibin3<8;ibin3++){
        ...
        GenJet_GenTrack_hJetTrackSignalBackground[ibin][ibin3] -> Scale(1./GenJet_GenTrack_hJetTrackSignalBackground[ibin][ibin3]->GetXaxis()->GetBinWidth(1));
        GenJet_GenTrack_hJetTrackSignalBackground[ibin][ibin3] -> Scale(1./integral_gen);
        ...
        RecoJet_GenTrack_hJetTrackSignalBackground[ibin][ibin3] -> Scale(1./RecoJet_GenTrack_hJetTrackSignalBackground[ibin][ibin3]->GetXaxis()->GetBinWidth(1));
        RecoJet_GenTrack_hJetTrackSignalBackground[ibin][ibin3] -> Scale(1./integral_reco);
        ...
        q_RecoJet_GenTrack_hJetTrackSignalBackground[ibin][ibin3] -> Scale(1./q_RecoJet_GenTrack_hJetTrackSignalBackground[ibin][ibin3]->GetXaxis()->GetBinWidth(1));
        q_RecoJet_GenTrack_hJetTrackSignalBackground[ibin][ibin3] -> Scale(1./integral_reco_q); 
        ...
        g_RecoJet_GenTrack_hJetTrackSignalBackground[ibin][ibin3] -> Scale(1./g_RecoJet_GenTrack_hJetTrackSignalBackground[ibin][ibin3]->GetXaxis()->GetBinWidth(1));
        g_RecoJet_GenTrack_hJetTrackSignalBackground[ibin][ibin3] -> Scale(1./integral_reco_g);
...
*/
        ...
        recogen_gengen[ibin][ibin3] = RecoJet_GenTrack_hJetTrackSignalBackground[ibin][ibin3] -> ProjectionX();
        //recogen_gengen[ibin][ibin3] -> Scale(1./((RecoJet_GenTrack_hJetTrackSignalBackground[ibin][ibin3]->GetXaxis()->GetBinWidth(1))));      
...
*/
        ...
        recogen_gengen_q[ibin][ibin3] = q_RecoJet_GenTrack_hJetTrackSignalBackground[ibin][ibin3] -> ProjectionX();  
        //recogen_gengen_q[ibin][ibin3] -> Scale(1./((q_RecoJet_GenTrack_hJetTrackSignalBackground[ibin][ibin3]->GetXaxis()->GetBinWidth(1))));
...
*/
        ...
        recogen_gengen_g[ibin][ibin3] = g_RecoJet_GenTrack_hJetTrackSignalBackground[ibin][ibin3] -> ProjectionX();
        //recogen_gengen_g[ibin][ibin3] -> Scale(1./((g_RecoJet_GenTrack_hJetTrackSignalBackground[ibin][ibin3]->GetXaxis()->GetBinWidth(1))));
        ...
        recogen_gengen_g[ibin][ibin3] -> GetYaxis() -> SetRangeUser((recogen_gengen_q[ibin][ibin3]->GetBinContent(recogen_gengen_q[ibin][ibin3]->GetMinimumBin()))*1.2,(recogen_gengen_g[ibin][ibin3]->GetBinContent(recogen_gengen_g[ibin][ibin3]->GetMaximumBin()))*3);  
      ...
      hintegral_eta_g[ibin]->GetYaxis()->SetRangeUser(hintegral_eta_q[ibin]->GetBinContent(hintegral_eta_q[ibin]->GetMinimumBin())*1.2,hintegral_eta_g[ibin]->GetBinContent(hintegral_eta_g[ibin]->GetMaximumBin())*3);
    }     
